...
This targets a conventional set of endpoints (`/api/research/prompt`,
`.../prompt/manual`, `.../prompt/consume`); a backend that doesn't implement
them simply 404s and the run falls back.
"""
